 ...
 ***************************************************************************/
#ifndef __APP_COMMON_SERVICEDISPATCHER_H__
#define __APP_COMMON_SERVICEDISPATCHER_H__
...
class ServiceDispatcher : public CM::Listener
{
	private:
	...
	public:
		...
		ServiceDispatcher(FileService &fileService);
		~ServiceDispatcher();
	...
	public:
		...
		void dispatch(std::string &id, CP::DataStructure *ds);

	private:

		void onVehicleData(CarDescriptionInfo *carInfo);
