 ...
 ***************************************************************************/
#ifndef __LIBRARY_BUFFER_DATABUFFER_H__
#define __LIBRARY_BUFFER_DATABUFFER_H__
...
class DataBuffer
{
	...
	public:
         ...
         */
        virtual int32 capacity() const {
            return this->_capacity;
        }

		/**
         * Sets this buffer's capacity. If the mark is defined and larger than the
         * new capacity then it is discarded.
         *
         * @param newCapacity
         *      The new capacity in the buffer to set.
         *
         * @returns a reference to This buffer.
         *
         */
		virtual DataBuffer& capacity(int32 newCapacity);
         ...
         *
         */
        virtual DataBuffer& position(int32 newPosition);

        /**
         * @returns this buffers Limit
         */
        virtual int32 limit() const {
            return this->_limit;
        }
         ...
         *
         */
        virtual DataBuffer& limit( int32 newLimit );
